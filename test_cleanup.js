...
console.log('After click before cleanup:', linkPreviewApplied);

cleanup();

linkPreviewApplied = true;
console.log('Reset state:', linkPreviewApplied);
mockDocument.dispatchEvent({ type: 'click', target: {} });
console.log('After click after cleanup:', linkPreviewApplied);
